    ...
    <section>
        ...
        <div class="roadmap-section-1-bg">
            <div class="roadmap-section-1">
                <div class="container">
                    <div class="row roadmap-header-section">
                        <div class="col-xl-8 col-lg-10 mx-auto home-section-1-description">
                            <div class="header-title">
                                <h1><?php the_field("section_1_title", "option"); ?></h1>
                            </div>
                            <?php the_field("section_1_content", "option"); ?>
                            <div class="home-section-1-button">
                                ...
                                ?>
                                    <span class="home-section-1-button1 buttons">
                                ...
                                <?php
                                $link = get_field('header_button_2', "option");
                                if ($link) :
                                    $link_url = $link['url'];
                                    $link_title = $link['title'];
                                    $link_target = $link['target'] ? $link['target'] : '_self';
