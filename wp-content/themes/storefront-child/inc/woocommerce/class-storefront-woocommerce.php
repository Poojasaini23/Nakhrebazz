...
if (!class_exists('Storefront_WooCommerce')) :
	...
	class Storefront_WooCommerce
	{
		...
		public function change_breadcrumb_delimiter($defaults)
		{
			...
			$defaults['wrap_before'] = '<div class="storefront-breadcrumb">
			<div class="container">
			<div class="row">
			<div class="col-md-12">
			<nav class="woocommerce-breadcrumb" 
			aria-label="' . esc_attr__('breadcrumbs', 'storefront') . '">';
			$defaults['wrap_after']  = '</nav></div></div></div></div>';
			return $defaults;
		}
