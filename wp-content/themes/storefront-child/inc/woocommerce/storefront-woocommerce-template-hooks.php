...
add_action('homepage', 'storefront_popular_products', 40);
 ...
 * Product Detail
 *
 * @see  storefront_related_products()
 * @see  storefront_recently_products()
 */
add_action('Product_detail', 'storefront_related_products', 20);
add_action('Product_detail', 'storefront_recently_products', 30);
 ...
 */
add_action('storefront_header_icons', 'storefront_product_user', 40);
add_action('storefront_header_icons', 'storefront_product_search', 40);
add_action('storefront_header_icons', 'storefront_header_cart', 40);
